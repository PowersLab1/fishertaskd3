...
function startExperiment() {
    ...
    const mainTrials = [mainTrials9, mainTrials5, mainTrials10, mainTrials6, mainTrials3, mainTrials1, mainTrials2, mainTrials4, mainTrials8, mainTrials7];
    ...
    // const blockOrderD = [mainTrials9, mainTrials5, mainTrials10, mainTrials6, mainTrials3, mainTrials1, mainTrials2, mainTrials4, mainTrials8, mainTrials7];
    // const blockOrderE = [mainTrials4, mainTrials8, mainTrials1, mainTrials9, mainTrials7, mainTrials10, mainTrials3, mainTrials6, mainTrials2, mainTrials5];
    ...
    function endExperiment() {
        ...
        sessionStorage.setItem('fishertaskd3taskData', trialsDataJson);
        window.postMessage({
            type: 'fishertaskd3labjs.data',
            json: trialsDataJson
        }, '*');
    }
